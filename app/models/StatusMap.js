...
module.exports={
  ...
  'AIRCRAFT_ARMED':{
    ...
    turn_on_ontrue:[],
    turn_off_ontrue: ['AIRCRAFT_INITIALIZE','AIRCRAFT_RUNNING','AIRCRAFT_KILLMODE_WARNING','AIRCRAFT_KILLMODE','AIRCRAFT_UNARMED'],
    turn_on_onfalse:[],
    turn_off_onfalse:[],
    priority:0,
    timeout: 0
  ...
  'AIRCRAFT_UNARMED':{
    status: false,
    message: 'Aircraft UNARMED',
    turn_on_ontrue:[],
    turn_off_ontrue: ['AIRCRAFT_INITIALIZE','AIRCRAFT_RUNNING','AIRCRAFT_KILLMODE_WARNING','AIRCRAFT_KILLMODE','AIRCRAFT_ARMED'],
    turn_on_onfalse:[],
    turn_off_onfalse:[],
    priority:1,
    timeout: 0
  ...
  'AIRCRAFT_INITIALIZE':{
    ...
    turn_on_ontrue:[],
    turn_off_ontrue: ['AIRCRAFT_RUNNING','AIRCRAFT_ARMED','AIRCRAFT_KILLMODE_WARNING','AIRCRAFT_KILLMODE','Aircraft UNARMED'],
    turn_on_onfalse:[],
    turn_off_onfalse:[],
    priority:1,
    timeout: 0
  ...
  'AIRCRAFT_RUNNING':{
    ...
    turn_on_ontrue:[],
    turn_off_ontrue: ['AIRCRAFT_INITIALIZE','AIRCRAFT_ARMED','AIRCRAFT_KILLMODE_WARNING','AIRCRAFT_KILLMODE','AIRCRAFT_UNARMED'],
    turn_on_onfalse:[],
    turn_off_onfalse:[],
    priority:1,
    timeout: 0
  ...
  'AIRCRAFT_KILLMODE_WARNING':{
    ...
    turn_on_ontrue:[],
    turn_off_ontrue: ['AIRCRAFT_INITIALIZE','AIRCRAFT_RUNNING','AIRCRAFT_ARMED','AIRCRAFT_KILLMODE','AIRCRAFT_UNARMED'],
    turn_on_onfalse:[],
    turn_off_onfalse:[],
    priority:0,
    timeout: 0
  ...
  'AIRCRAFT_KILLMODE':{
    ...
    turn_on_ontrue:[],
    turn_off_ontrue: ['AIRCRAFT_INITIALIZE','AIRCRAFT_RUNNING','AIRCRAFT_ARMED','AIRCRAFT_KILLMODE_WARNING','AIRCRAFT_UNARMED'],
    turn_on_onfalse:[],
    turn_off_onfalse:[],
    priority:0,
    timeout: 0
